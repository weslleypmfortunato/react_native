...
export default function Home () {
  ...
  function handleDelete (data) {
    ...
    if (isBefore(dateItem, dateHoje)) {
      // se a data do registro já passou (ou seja, é antiga) vai entrar aqui
  ...
  return (
    <Background>
      ...
      <Container>
        ...
        {/* funcionaria sem o regex, somente com o toFixed */}
      </Container>

      <Area>
        <TouchableOpacity onPress={handleShowPicker}>
          <FontAwesomeIcon icon={faCalendarDays} color="#FFF" size={30} />
        </TouchableOpacity>
